...
namespace UdemyClone.DataAccess.Migrations
{
    ...
    [Migration("20251001164831_AddCourseRatingTable")]
    partial class AddCourseRatingTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UdemyClone.Models.Cart", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UdemyClone.Models.CourseRating", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UdemyClone.Models.OrderDetail", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UdemyClone.Models.OrderHeader", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UdemyClone.Models.UserCourseProgress", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UdemyClone.Models.UserVideoProgress", b =>
                {
                    ...
                    b.HasIndex("UserCourseProgressId");
            ...
            modelBuilder.Entity("UdemyClone.Models.CourseRating", b =>
                {
                    ...
                    b.HasOne("UdemyClone.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UdemyClone.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("UdemyClone.Models.OrderHeader", "OrderHeader")
            ...
            modelBuilder.Entity("UdemyClone.Models.UserCourseProgress", b =>
                {
                    ...
                    b.HasOne("UdemyClone.Models.CourseVideo", "CurrentVideo")
                        .WithMany()
